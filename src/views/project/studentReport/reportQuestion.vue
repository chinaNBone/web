<template>
  <div class="g-nav">
    <div class="l-mod l-edit" style="box-shadow:none;padding:0;margin:0;">
      ...
      <div class="l-con">
        ...
        <div class="d-info">
          ...
          <div class="d-mod">
            <div class="d-mod-q">
              <h2>
                ...
                <el-checkbox v-model="questionSet.isRequired">必答题</el-checkbox>
              </h2>
          ...
          <div class="d-set">
            ...
            <div>
              <el-button type="primary" @click="edit(0)">保 存</el-button>
              <el-button type="primary" @click="edit(1)">保存并发布报到</el-button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    editRow(val, index) {
      ...
      this.questionSet.isRequired = val.isRequired == 0 ? true : false;
    ...
    edit(flag) {
      let par = {
        ...
        questionnaireDetails: this.question
      };
      this.$http
        .post("/api/web/studentReport/saveOrPublish", {
          key: JSON.stringify(par)
        })
        .then(res => {
          if (flag != 0) {
            this.$message({
    ...
    publish(flag) {
      let par = {
        ...
        title: this.info.title,
        description: this.info.description,
        questionnaireDetails: JSON.stringify(this.question)
      };
      this.$http
